...
// @match        https://v16m-default.akamaized.net/*
// @match        https://v26.toutiaovod.com/*
...
let currentSite = {
  // address: /.*:\/\/.*\.yhpdm\.net\/vp\/.*/,
  videoFrame: 'body > video > iframe',
  videoFrameURL: "https://v16m-default.akamaized.net/",
  container: "body",
  video: "body > video",
}
...
showChoosePanel('', keyword, episode, currentSite, iframe);
